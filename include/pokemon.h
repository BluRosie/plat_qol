...
POKEMON_PARAM *__attribute__((long_call)) PokeParty_GetMemberPointer(void *party, u32 pos);
u32 *__attribute__((long_call)) PokeWazaMachineCheck(u32 species, u32 form, u32 machine_id);
